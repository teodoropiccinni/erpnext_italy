frappe.ui.form.on('Foreign Purchase Invoice It Sdi Import', {
	onload(frm) {
	...
	refresh(frm) {
		...
		if (!frm.doc.__islocal) {
			frm.set_intro(
				__('Only autofattura documents (TD17–TD27) will be imported. Other document types are logged and skipped.'),
				'blue'
			);
		}
	},
